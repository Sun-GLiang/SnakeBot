...
public class WebSocketServer {
    ...
    // 存储所有玩家的链接
    final public static ConcurrentHashMap<Integer, WebSocketServer> users = new ConcurrentHashMap<>(); // 线程安全的hash，将userId映射到WebSocketServer
    private User user;
    ...
    public static void startGame(Integer aId, Integer aBotId, Integer bId, Integer bBotId) {
        ...
        game.createGameMap();
        if (users.get(a.getId()) != null) users.get(a.getId()).game = game; // game赋给a对应的链接
